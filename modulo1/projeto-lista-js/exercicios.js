...
const largura = Number (prompt ("Qual é largura do retangulo?"))
...
function imprimeIdade() {
  ...
  const seuAnoDeNascimento = Number (prompt ("Qual é o seu ano de nascimento?"))
  console.log(anoAtual - seuAnoDeNascimento)
}
